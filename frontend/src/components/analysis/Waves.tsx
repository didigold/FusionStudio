...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      const isCyan = configRef.current.lineColor.includes('170') || configRef.current.lineColor.includes('AAFF') || configRef.current.lineColor.includes('blue');
      if (isCyan) {
        grad.addColorStop(0, 'rgba(0, 100, 255, 0.08)');
        grad.addColorStop(0.25, 'rgba(0, 190, 255, 0.55)');
        grad.addColorStop(0.5, 'rgba(0, 240, 255, 0.95)');
        grad.addColorStop(0.75, 'rgba(0, 190, 255, 0.55)');
        grad.addColorStop(1, 'rgba(0, 100, 255, 0.08)');
      } else {
        grad.addColorStop(0, 'rgba(0, 200, 100, 0.08)');
        grad.addColorStop(0.25, 'rgba(0, 255, 120, 0.55)');
        grad.addColorStop(0.5, 'rgba(100, 255, 180, 0.95)');
        grad.addColorStop(0.75, 'rgba(0, 255, 120, 0.55)');
        grad.addColorStop(1, 'rgba(0, 200, 100, 0.08)');
      }
